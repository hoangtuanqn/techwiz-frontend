    ...
    return (
        <section id="features" className="py-16 md:py-20">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <p className="mx-auto mt-2 max-w-3xl text-center text-slate-600" data-aos="fade-up" data-aos-delay="40">
                ...
                <div className="mt-10 grid gap-6 md:grid-cols-3">
                    <div
                        className="rounded-2xl border border-slate-200 p-6 shadow transition hover:shadow-md"
                        data-aos="fade-up"
                    >
