...
export default function AdminsPage() {
    ...
    const {
        ...
        queryKey: ["adminUsers", page, "admin"],
        queryFn: async () => {
            const res = await userAdminApi.getUsers(+(page || 1), 20, "", "", "filter[role]=admin");
    ...
    if (error) {
        return (
            <div className="flex min-h-[400px] items-center justify-center">
                <div className="text-center">
                    <p className="mb-2 text-red-600">Error loading admins</p>
    ...
    return (
        <RoleList
            ...
            subtitle={`Manage platform administrators (${transformedUsers.length} total)`}
